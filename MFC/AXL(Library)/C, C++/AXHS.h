...
// Define Baseboard
    ...
    typedef enum _AXT_BASE_BOARD
    {
        ...
        AXT_PCIE_DB64R                = 0x64,             // PCIe bus, Digital IN 32��, OUT 32 point
...
// Define Module
    ...
    typedef enum _AXT_FUNC_RESULT
    {
        ...
        AXT_RT_NETWORK_LOCK_MISMATCH        = 1153,       // Not match the Information(LOCK & SCAN)
...
//Mechatrolink III by SW1 2011.02.15
enum{
COM_CONNECT,
COM_DISCONNECT,
COM_OFFLINE
