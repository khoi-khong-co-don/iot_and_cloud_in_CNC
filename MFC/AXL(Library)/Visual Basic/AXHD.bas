...
Public Const QiPPOSRead = &H9                               ' Previous Drive pulse amount data/Inte                                                                                                                                                                                                                                                                                                                                                                             rpolation end position READ
Public Const QiPPOSWrite = &H89                             ' Previous Drive pulse amount data/Inte                                                                                                                                                                                                                                                                                                                                                                             rpolation end position WRITE
...
Public Const QiPISNUMRead = &HB                             ' Previous Interpolation step number RE                                                                                                                                                                                                                                                                                                                                                                             AD
Public Const QiPISNUMWrite = &H8B                           ' Previous Interpolation step number WR                                                                                                                                                                                                                                                                                                                                                                             ITE
...
Public Const QiPOPPRE = &H8D                                ' Pop and shift data of previous drivin                                                                                                                                                                                                                                                                                                                                                                             g data Queue.
...
Public Const QiCENTRead = &H1A                              ' Circular Int. center/Master axis targ                                                                                                                                                                                                                                                                                                                                                                             et position for multiple chip linear int. READ
Public Const QiCENTWrite = &H9A                             ' Circular Int. center/Master axis targ                                                                                                                                                                                                                                                                                                                                                                             et position for multiple chip linear int. WRITE
Public Const QiISNUMRead = &H1B                             ' Interpolation step number READ
Public Const QiISNUMWrite = &H9B                            ' Interpolation step number WRITE
Public Const QiREMAIN = &H1C                                ' Remain pulse data after stopping pres                                                                                                                                                                                                                                                                                                                                                                             et drive function abnormally.
...
Public Const QiSQRO1 = &HA6                                 ' Output one shot of the start pulse fo                                                                                                                                                                                                                                                                                                                                                                             rm SQSTR1 terminal.
Public Const QiNoOperation_27 = &H27                        ' No operation.
Public Const QiSQRO2 = &HA7                                 ' Output one shot of the start pulse fo                                                                                                                                                                                                                                                                                                                                                                             rm SQSTR2 terminal.
...
Public Const QiSQSTP1 = &HAA                                ' Output one shot of the stop pulse fro                                                                                                                                                                                                                                                                                                                                                                             m SQSTP1 terminal.
Public Const QiNoOperation_2B = &H2B                        ' No operation.
Public Const QiSQSTP2 = &HAB                                ' Output one shot of the stop pulse fro                                                                                                                                                                                                                                                                                                                                                                             m SQSTP2 terminal.
Public Const QiISCNTRead = &H2C                             ' Interpolation stop counter value READ                                                                                                                                                                                                                                                                                                                                                                             .
Public Const QiNoOperation_AC = &HAC                        ' No operation.
Public Const QiISACNTRead = &H2D                            ' Interpolation step counter READ for a                                                                                                                                                                                                                                                                                                                                                                             dvanced deceleration mode .
...
'Public Const QiNoOperation_30 = &H30                       ' Driven pulse amount during last drivin                                                                                                                                                                                                                                                                                                                                                                               g(Interpolation step counter for path move).
'Public Const QiDRPCNTRead = &HB0                           ' No operation
Public Const QiDRPCNTRead = &H30                            ' No operation
Public Const QiNoOperation_B0 = &HB0                        ' Driven pulse amount during last drivin                                                                                                                                                                                                                                                                                                                                                                             g(Interpolation step counter for path move).
...
Public Const QiCQ1Read = &H43                               ' Script1 captured data queue register(t                                                                                                                                                                                                                                                                                                                                                                             op of depth 15 Queue)READ.
...
Public Const QiCQ2Read = &H48                               ' Script2 captured data queue register(t                                                                                                                                                                                                                                                                                                                                                                             op of depth 15 Queue)READ.
...
Public Const QiNoOperation_CF = &HCF                        ' [No operation code for script reservat                                                                                                                                                                                                                                                                                                                                                                             ion command].
...
Public Const QiINITSQWrite = &HD7                           ' Initialize script queues with target s                                                                                                                                                                                                                                                                                                                                                                             election.
Public Const QiNoOperation_58 = &H58                        ' No operation.
Public Const QiINITCQWrite = &HD8                           ' Initialize captured data queue with ta                                                                                                                                                                                                                                                                                                                                                                             rget selection.
