...
CSXButton::CSXButton()
:	m_bCheckState(FALSE),
	m_uDownEventID(SX_LBUTTON_DOWN),
	m_uUpEventID(SX_LBUTTON_UP),
	m_BtnType(0)
...
void CSXButton::SetType(int type)
{
	m_BtnType = type;
}

void CSXButton::SetDownMessage(UINT nMessage)
{
	m_uDownEventID = nMessage;
}

void CSXButton::SetUpMessage(UINT nMessage)
{
	m_uUpEventID = nMessage;
}
